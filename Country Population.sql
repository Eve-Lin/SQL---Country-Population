...
SELECT*FROM countries_by_population ORDER BY population DESC;
SELECT country,  MIN(population) FROM countries_by_population;
SELECT country,  AVG(population) FROM countries_by_population;
SELECT country,  MAX(population) FROM countries_by_population;
SELECT COUNT(country),
CASE
WHEN median_age>30 THEN "above_30"
WHEN median_age<=30 THEN "Below_30"
END as "age_range"
FROM countries_by_population GROUP BY age_range HAVING age_range="Below_30";
SELECT*FROM countries_by_population GROUP BY population_change HAVING population>1000000000 AND percent_one_year_change>1.00
